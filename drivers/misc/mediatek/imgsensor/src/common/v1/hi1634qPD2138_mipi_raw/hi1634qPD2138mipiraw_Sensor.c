...
#include "hi1634qPD2138mipiraw_Sensor.h"
...
static struct imgsensor_info_struct imgsensor_info = {
	.sensor_id = HI1634QPD2138_SENSOR_ID,
...
extern otp_error_code_t MAIN3_OTP_ERROR_CODE_HI1634QPD2102;
MUINT32  sn_inf_main2_hi1634qpd2102[13];
MUINT32  material_inf_main_hi1634qpd2102[4];
	...
	case SENSOR_FEATURE_GET_CUSTOM_INFO:
		...
		switch (*feature_data) {
			...
			if (*feature_para_len >= sizeof(MUINT32)*13 + 2) {
			    *(MUINT32 *)(uintptr_t)(*(feature_data+1)) = MAIN3_OTP_ERROR_CODE_HI1634QPD2102;//otp_state
				memcpy( feature_data+2, sn_inf_main2_hi1634qpd2102, sizeof(MUINT32)*13); 
				memcpy( feature_data+10, material_inf_main_hi1634qpd2102, sizeof(MUINT32)*4); 
			#if 0
						for (i = 0 ; i<12 ; i++ ){
...
UINT32 HI1634QPD2138_MIPI_RAW_SensorInit(struct SENSOR_FUNCTION_STRUCT **pfFunc)
{
