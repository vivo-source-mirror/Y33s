...
#include "s5kjn1sq03PD2147mipiraw_Sensor.h"
...
static struct imgsensor_info_struct imgsensor_info = {
	.sensor_id = S5KJN1SQ03PD2138_SENSOR_ID,
...
MUINT32  crosstalk_data_PD2147[PDAF_DATA_SIZE - 2];  /*0 flag   1-836 data*/
...
static int s5kjn1sq03PD2147_read_framelength;
static int s5kjn1sq03PD2147_read_shutter;
static int s5kjn1sq03PD2147_read_gain;
#endif
...
#ifdef READ_FRAMELENGTH_SHUTTER_GAIN
	s5kjn1sq03PD2147_read_framelength = read_cmos_sensor_16_16(0x0340);
	s5kjn1sq03PD2147_read_shutter = read_cmos_sensor_16_16(0x0202);
	PK_DBG("s5kjn1sq03PD2147_read_shutter = %d, s5kjn1sq03PD2147_read_framelength = %d \n", s5kjn1sq03PD2147_read_shutter,s5kjn1sq03PD2147_read_framelength);
#endif
}	/*	write_shutter  */
	...
	case SENSOR_FEATURE_GET_4CELL_DATA:/*get 4 cell data from eeprom*/
	{
		...
		if (type == FOUR_CELL_CAL_TYPE_XTALK_CAL) {
			...
			for(i = 0; i < PDAF_DATA_SIZE - 2 ; i++) {
				data[2 + i] = crosstalk_data_PD2147[i];
			}
		}
 	}
  	  break;
...
UINT32 S5KJN1SQ03PD2147_MIPI_RAW_SensorInit(
