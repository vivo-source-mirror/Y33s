...
#include "imgsensor.h"
#include "s5kjn1sq03PD2138v1mipiraw_Sensor.h"
...
extern MUINT32 crosstalk_data_PD2138v1[PDAF_DATA_SIZE - 2];  /*0 flag   1-606 data*/
...
int MAIN_38E1_otp_read_v1(void)
{
	...
	if (check_if_group_valid == 0x01) { /****all the data is valid****/
		...
		for (i = 0; i < PDAF_DATA_SIZE - 2; i++) {
			...
			crosstalk_data_PD2138v1[i]=vivo_otp_data_s5kjn1sq03v1[XTC_cal_addr + i + index];
		}
