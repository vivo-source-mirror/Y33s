...
#include "imx355PD2104mipiraw_Sensor.h"

/************************Modify Following Strings for Debug********************/
#define PFX "IMX355PD2104_camera_sensor"
#define LOG_1 LOG_INF("IMX355PD2104,MIPI 4LANE\n")
/************************   Modify end    *************************************/
...
static struct imgsensor_info_struct imgsensor_info = {
	.sensor_id = IMX355PD2104_SENSOR_ID,
...
UINT32 IMX355PD2104_MIPI_RAW_SensorInit(struct SENSOR_FUNCTION_STRUCT **pfFunc)
{
	if (pfFunc != NULL)
		*pfFunc = &sensor_func;
	return ERROR_NONE;
