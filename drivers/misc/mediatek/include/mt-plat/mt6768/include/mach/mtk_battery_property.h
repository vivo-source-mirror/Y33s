...
#if defined(CONFIG_VIVO_CHARGING_FOR_PD1913F) || defined(CONFIG_VIVO_CHARGING_FOR_PD1934) \
	|| defined(CONFIG_VIVO_CHARGING_FOR_PD2103) || defined(CONFIG_VIVO_CHARGING_FOR_PD2138)
#define R_FG_VALUE 5
#else
