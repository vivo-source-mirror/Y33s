...
static int state_pin_short = 0;//20210519 zhujianjia add for I2C short to GND test.
...
static int lm3644_i2c_probe(struct i2c_client *client, const struct i2c_device_id *id)
{
	...
	if(device_id<0){  //20210519 zhujianjia add i2c_smbus_read_byte_data return <0 if i2c failed
