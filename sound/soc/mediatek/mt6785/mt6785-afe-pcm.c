...
static int mt6785_afe_pcm_copy(struct snd_pcm_substream *substream,
			       ...
			       mtk_sp_copy_f sp_copy)
{
	...
	//mt6785_set_audio_int_bus_parent(afe, CLK_TOP_MAINPLL_D4_D4);
...
******************************************************************************/
static void __init mt6785_proc_dump_register(struct mtk_base_afe *afe)
{
	...
	entry = proc_create_data("mtksocaudio", 0664, NULL, &mt6785_debugfs_ops, afe);
	if (!entry)
